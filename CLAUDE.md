...
- **Не запускать тесты самостоятельно**: После написания теста не запускай phpunit. Пользователь сам запустит тесты при необходимости.
- Каждый раз при исправлении README.md делай исправления в README-файлах для других языков (переводы).