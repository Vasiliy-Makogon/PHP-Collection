 ...
 * демонстрирующий, что все элементы типа array, переданные в объектный массив посредством
 * конструктора или set-методов, будут становиться объектами текущего типа,
 * т.е. NewTypeArray extends CoverArray
 */
