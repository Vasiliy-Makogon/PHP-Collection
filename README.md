...
| `array_other_function(int $value)`                             | 🔴                                                                                   | 🔴                                               | BadMethodCallException: Krugozor\Cover\CoverArray::__call: first parameter of the function `array_other_function` must be declared as `array` |
