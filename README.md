...
<table><thead><tr><th><span>Method</span></th><th><span>Purpose</span></th><th><span>Access</span></th></tr></thead><tbody><tr><td><code>copy()</code></td><td><span>Creates a shallow copy of the current object with deep cloning of immediate object properties</span></td><td><span>Public</span></td></tr><tr><td><code>getDataAsArray()</code></td><td><span>Returns the current object's data as a native PHP array with all nested CoverArray instances converted</span></td><td><span>Public</span></td></tr><tr><td><code>get(string $path)</code></td><td>Returns data by keys using dot notation (e.g., 'user.profile.name')</td><td><span>Public</span></td></tr><tr><td><code>fromJson()</code></td><td><span>Creates a CoverArray instance from a JSON string (static method)</span></td><td><span>Public Static</span></td></tr><tr><td><code>toJson()</code></td><td><span>Converts the CoverArray to a JSON string</span></td><td><span>Public</span></td></tr><tr><td><code>fromExplode()</code></td><td><span>Creates a CoverArray from a string using explode() (static method)</span></td><td><span>Public Static</span></td></tr><tr><td><code>fromArray()</code></td><td><span>Creates a CoverArray from a native PHP array (static method)</span></td><td><span>Public Static</span></td></tr><tr><td><code>implode()</code></td><td><span>Joins array elements with a string (equivalent to implode())</span></td><td><span>Public</span></td></tr><tr><td><code>isEmpty()</code></td><td><span>Checks if the array contains no elements</span></td><td><span>Public</span></td></tr><tr><td><code>each()</code></td><td><span>Applies a callback function to each element (for associative arrays)</span></td><td><span>Public</span></td></tr><tr><td><code>eachRecursive()</code></td><td><span>Recursively applies a callback function to all elements</span></td><td><span>Public</span></td></tr><tr><td><code>prepend()</code></td><td><span>Prepends one or more elements to the beginning of an array (alias of unshift)</span></td><td><span>Public</span></td></tr></tbody></table>
